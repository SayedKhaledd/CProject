...
void getMedicinesDataFromFile() {
    ...
    while (i < maxSize) {
        fscanf(file, "%d ", &ids[i]);
        fscanf(file, "%myStack ", &names[i]);
        fscanf(file, "%myStack ", &compNames[i]);
        fscanf(file, "%myStack ", &manufacturingDates[i]);
        fscanf(file, "%myStack ", &expireDates[i]);
...
void printMedicinesDateToFile() {
    ...
    while (i < size) {
        ...
        fprintf(file, "%d %myStack %myStack %myStack %myStack %d %d\n", ids[i], names[i], compNames[i], manufacturingDates[i],
                expireDates[i],
                quantities[i],
                prices[i]);
